...
def main():
    ...
    # Configuration
    REQUIRED_CONSECUTIVE_FRAMES = 25  # Frames needed to accept a character
    WORD_DELAY = 3                 # Seconds before auto-adding space
    SENTENCE_DELAY = 5             # Seconds before speaking sentence
    RESET_DELAY = 10                # Seconds before resetting everything
    INPUT_COOLDOWN = 3              # Seconds before accepting new input after recognition
